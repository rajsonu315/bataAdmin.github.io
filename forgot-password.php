                        ...
                        <div class="col-12 position-relative page-content">
                            <div class="row justify-content-center h-100">
                                <div class="col-12 col-md-9 col-lg-8 col-xxl-6 align-self-center">
                                    ...
                                    <p class="text-center text-secondary mb-4">Reset your password</p>
                                    <div class="card border-0 mb-4">
                                        <div class="card-body">
                                            <p class="text-secondary text-center small">Provide your registered email address to reset your password. We will send you a email with link to set new password with steps and information.</p>
                                            <!-- form elements -->
                                            <form>
                                    ...
                                    <p class="text-secondary text-center mb-4">Already have account? <a href="login.php">Sign in</a> here</p>
                                </div>
                            </div>
                        </div>
